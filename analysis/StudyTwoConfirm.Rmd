...
modelplot <-get_model_data(S2glmm, type = "int", mdrt.values = "meansd")
```
...
s2SimpleSlopes <- emmeans(S2glmm, ~rumination*Timepoint, at = s2SimpleList)

contrast(s2SimpleSlopes, "pairwise", by = "rumination")
```
