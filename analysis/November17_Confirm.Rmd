...
s1 <- read_csv(here::here("data", "MusicEmotionRegulation_November17_Prolifc.csv")) %>%  
...
s1 <- s1 %>% 
  mutate(rumination = rowMeans(dplyr::select(., RUM1:RUM12)), 
...
write_csv(s1, here::here("data", "MusicEmotionRegulation_November17_Prolifc_Processed.csv"))
```
