...
```{r s2apacorrealtions, echo = FALSE}

apa::cor_apa(cor.test(s2explore$rumination, s2explore$mesi), format = "rmarkdown")
...
There was no correlation between rumination and music use for emotion regulation *r*(164) = .11, *p* = .162


There was no correlation between music for emotion regulation and difficulties in regulating emotions *r*(164) = .06, *p* = .419


There was no correlation between rumination and expressed song valence, *r*(121) = .04, *p* = .671



There was no correlation between rumination and expressed song energy *r*(121) = -.08, *p* = .381


There was no correlation between music use for emotion regulation and expressed song valence, *r*(121) = .00, *p* = .997
 


There was no correlation between music use for emotion regulation and expressed song energy *r*(121) = .01, *p* = .930
...
```{r apafomratttest, echo = FALSE}
apa::t_apa(t.test(s2clusters$rumination~s2clusters$KmeansCluster, var.equal = TRUE), format = "rmarkdown")
apa::t_apa(t.test(s2clusters$mesi~s2clusters$KmeansCluster, var.equal = TRUE), format = "rmarkdown")
```

The was no difference in rumination scores across clusters *t*(121) = 0.86, *p* = .390, *d* = 0.16

Nor was there anyd difference in music for emotion regulation across scores *t*(121) = 0.25, *p* = .801, *d* = 0.05

#Qualitative coding 

see [here](s2QualitativeCoiding.html) for coding description
```{r}
